...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      .setTitle("❃D✯U✯R✯G✯E✯S✯H❃ Help")
      .setAuthor('Click here to invite me!!', 'https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif', 'https://discord.com/oauth2/authorize?client_id=809549806178402334&scope=bot&permissions=804781377')
      ...
      switch(args[0]){
          ...
          if(!message.guild) {
            if(!args[0]) {message.react(process.env.aemoji);return message.channel.send(helpEmbed);}
            return
            }
