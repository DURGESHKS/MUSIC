...
execute(message) {
    ...
    message.react(process.env.aemoji).catch(console.error);
    //get the queue
    ...
    queue.textChannel.send(
      new MessageEmbed().setColor(process.env.embcol).setAuthor(`${message.author.username} skipped the song.`, "https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif")
    ).catch(console.error);
  }
};
